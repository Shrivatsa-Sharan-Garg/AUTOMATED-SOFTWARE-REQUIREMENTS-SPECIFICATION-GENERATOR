...
To maintain a "Sovereign" workflow within VS Code, use these extensions to manage data and view outputs without leaving the editor:
...
- **📄 Integrated PDF Preview**
  ...
  To view your generated IEEE SRS documents instantly after export:

  [🔗 vscode-pdf](https://marketplace.visualstudio.com/items?itemName=tomoki1207.pdf)

  Usage: Allows you to open and review the .pdf files generated by the engine directly in a VS Code tab.
